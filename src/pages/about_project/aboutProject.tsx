...
function AboutProject() {
    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-screen">
            ...
            <section id="about" className="w-full h-screen flex flex-col justify-center">
                <h1 className="text-center font-semibold text-2xl mb-5">О нас</h1>

                <div className="w-full flex justify-center items-center">
                    <Card className="border-4 border-primary py-8 px-10">
                        <CardHeader>
            ...
            <section id="aboutproject" className="w-full">
                <h1 className="text-center font-semibold text-2xl mb-5">О нашем проекте</h1>

                <div className="grid grid-cols-2 gap-x-4 gap-y-2 w-full">
                    {facilities.map((item) =>
                        <Card key={item.id} className="border-4 border-primary py-8 px-10">
                            <CardHeader>
                                <h1 className="text-4xl font-semibold">
                                    {item.title}
                                </h1>
